...
-- Last modification date: 2022-10-16 15:42:34.774
...
CREATE TABLE fruit (
    ...
    fruit_category_fruit_category_ID int  NOT NULL,
...
CREATE TABLE fruit_category (
    ...
    name varchar(50)  NOT NULL,
    CONSTRAINT fruit_category_pk PRIMARY KEY  (fruit_category_ID)
);
...
ALTER TABLE fruit ADD CONSTRAINT fruit_fruit_category
    FOREIGN KEY (fruit_category_fruit_category_ID)
    REFERENCES fruit_category (fruit_category_ID);
